 ...
 */
public class ChooseFileDialog extends JFileChooser {

    public ChooseFileDialog(String[] fileExtensions, String fileDescription, String title, Consumer<File> selectFileConsumer, Consumer<File> selectFileFailedConsumer) {
        this(new File("./"), fileExtensions, fileDescription, title, selectFileConsumer, selectFileFailedConsumer);
    }

    public ChooseFileDialog(File startDirectory, String[] fileExtensions, String fileDescription, String title, Consumer<File> selectFileConsumer, Consumer<File> selectFileFailedConsumer) {
